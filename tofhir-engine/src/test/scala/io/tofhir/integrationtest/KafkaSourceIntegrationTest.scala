...
class KafkaSourceIntegrationTest extends AnyFlatSpec with ToFhirTestSpec with BeforeAndAfterAll with OnFhirTestContainer {
  ...
  val patientMappingTask: FhirMappingTask = FhirMappingTask(
    ...
    sourceBinding = Map("source" -> KafkaSource(topicName = "patients", groupId = "tofhir", startingOffsets = "earliest"))
  )
  val otherObservationMappingTask: FhirMappingTask = FhirMappingTask(
    ...
    sourceBinding = Map("source" -> KafkaSource(topicName = "observations", groupId = "tofhir", startingOffsets = "earliest"))
  )
  val familyMemberHistoryMappingTask: FhirMappingTask = FhirMappingTask(
    ...
    sourceBinding = Map("source" -> KafkaSource(topicName = "familyMembers", groupId = "tofhir", startingOffsets = "earliest"))
  )
