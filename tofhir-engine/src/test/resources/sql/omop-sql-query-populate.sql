...
VALUES
    (1, 'Example care site name', 8717, 1, '2600GD', 'Inpatient Facility'),
...
VALUES
    (1, '19 Farragut', 'Oxford Street', NULL, 'MO', NULL, '26950', '26-950', 4330424, NULL, NULL, NULL),
...
VALUES(8756, 'Outpatient Hospital', 'Place of Service', 'Place of Service', 'Place of Service', 'S', '22', '1970-01-01', '2099-12-31', NULL),
    (8940, 'Office', 'Place of Service', 'Place of Service', 'Place of Service', 'S', '11', '1970-01-01', '2099-12-31', NULL),
    (8717, 'Inpatient Hospital', 'Place of Service', 'Place of Service', 'Place of Service', 'S', '21', '1970-01-01', '2099-12-31', NULL),
    (2000064, 'Percutaneous transluminal coronary angioplasty [PTCA]', 'Procedure', 'ICD9Proc', '4-dig billing code', 'S', '00.66', '2005-10-01', '2099-12-31', NULL),
    (2001220, 'Suture of laceration of palate', 'Procedure', 'ICD9Proc', '4-dig billing code', 'S', '27.61', '1970-01-01', '2099-12-31', NULL),
    (2008238, 'Transfusion of packed cells', 'Procedure', 'ICD9Proc', '4-dig billing code', 'S', '99.04', '1970-01-01', '2099-12-31', NULL),
    (2005595, 'Unspecified operation on bone injury, phalanges of hand', 'Procedure', 'ICD9Proc', '4-dig billing code', 'S', '79.94', '1970-01-01', '2099-12-31', NULL),
    (2005199, 'Bone graft, patella', 'Procedure', 'ICD9Proc', '4-dig billing code', 'S', '78.06', '1970-01-01', '2099-12-31', NULL),
    (4011566, 'Health visitor', 'Provider Specialty', 'SNOMED', 'Social Context', NULL, '159000000', '1970-01-01', '2016-07-30', 'D'),
    (4330153, 'Nurse practitioner', 'Provider Specialty', 'SNOMED', 'Social Context', NULL, '224571005', '1970-01-01', '2099-12-31', NULL);
...
VALUES
    (108599947, 906440, 2008238, '2010-04-25', NULL, NULL, NULL, 38000251, NULL, NULL, 48878, 43483680, NULL, '9904', 2008238, NULL),
    (114598132, 956309, 2000064, '2010-05-13', NULL, NULL, NULL, 38000251, NULL, NULL, 12731, 45887852, NULL, '0066', 2000064, NULL),
    (275191342, 2296927, 2005199, '2008-03-29', NULL, NULL, NULL, 38000251, NULL, NULL, 202664, 110204292, NULL, '7806', 2005199, NULL),
    (134276546, 1121148, 2005595, '2009-08-20', NULL, NULL, NULL, 38000251, NULL, NULL, 14272, 53771451, NULL, '7994', 2005595, NULL),
    (265732251, 2218124, 2001220, '2008-05-08', NULL, NULL, NULL, 38000251, NULL, NULL, 47376, 106415668, NULL, '2761', 2001220, NULL);
