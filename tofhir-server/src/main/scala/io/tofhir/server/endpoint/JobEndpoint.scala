...
class JobEndpoint(jobRepository: IJobRepository, projectRepository: IProjectRepository) extends LazyLogging {

  val service: JobService = new JobService(jobRepository, projectRepository)
